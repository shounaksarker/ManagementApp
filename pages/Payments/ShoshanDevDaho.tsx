          ...
          <Form className="py-4" onSubmit={handleSubmit}>
            ...
            <Row className="my-4">
              ...
              <Col md={6} className="">
                ...
                <Form.Control
                  type="number"
                  placeholder="Donation of burn certificate"
                  name="amount"
                  onBlur={handleChange}
                  required
                />
          ...
          <div style={{ display: "none" }}>
            <div className="printArea py-3 px-5" ref={componentRef}>
              ...
              <div className="mb-2 d-flex justify-content-center align-items-center">
                <h6 className={dtStyle.onudan}>Certificate of burn</h6>
              ...
              <div className="mt-3 lh-lg">
                ...
                <span className="fw-bold text-decoration-underline">
                  {singleUser.amount ? singleUser.amount : ""} Tk
                </span>{" "}
                (in bengali){" "}
                <span className="fw-bold text-decoration-underline">
